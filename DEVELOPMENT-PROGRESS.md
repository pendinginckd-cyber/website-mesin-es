...
| 1 Sep 2026 | SEO Lokal "mesin es kristal semarang": data bisnis terpusat `business.ts` (Cikal Jaya Teknik @ Genuk Semarang, merk EKN, telp 081234234684, geo -6.972509/110.485675, maps shortlink), title homepage + `layout` dibidik Semarang, schema `IndustrialBusiness` di homepage & landing baru `/mesin-es-kristal-semarang` (embed peta, area layanan Jateng, grid produk), sitemap + footer link, NAP default Firestore diisi alamat Genuk & email domain, draf 4 artikel silo siap-paste di `seo-local-semarang/` | Targeting keyword lokal komersial; Google Local Pack + organic lokal |

### Technical Notes:
- **SEO Lokal**: brand publik "Mesin Es Kristal", perusahaan "Cikal Jaya Teknik", merk "EKN", alamat "Jl. Kyai Krojo 14, Sembungharjo, Kec. Genuk, Kota Semarang, Jawa Tengah 50116". Landing lokal `/mesin-es-kristal-semarang` + schema `IndustrialBusiness` di homepage & landing. NAP harus konsisten dgn Google Business Profile (nama, alamat, telp 081234234684, WA 6281326440039).
- Off-page yang HARUS dikerjakan manual (di luar kode): klaim/verifikasi GBP "Cikal Jaya Teknik" (kategori Industrial Equipment Supplier), minta ulasan 5 bintang, daftar direktori B2B (Indotrading, Indonetwork, yellow pages), backlink media lokal. Setelah landing & draft artikel dipublish, resubmit sitemap di Google Search Console.
